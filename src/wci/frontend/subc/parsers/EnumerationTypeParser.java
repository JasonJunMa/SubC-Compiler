 ...
 *
 * <p>Parse a SubC enumeration type specification.</p>
 *
...
public class EnumerationTypeParser extends TypeSpecificationParser
{
     ...
     */
    protected EnumerationTypeParser(SubCParserTD parent)
    {
        super(parent);
    }

    // Synchronization set to start an enumeration constant.
    private static final EnumSet<SubCTokenType> ENUM_CONSTANT_START_SET =
        EnumSet.of(IDENTIFIER, COMMA);

    // Synchronization set to follow an enumeration definition.
    private static final EnumSet<SubCTokenType> ENUM_DEFINITION_FOLLOW_SET =
    ...
    /**
     * Parse a SubC enumeration type specification.
